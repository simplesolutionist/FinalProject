<template>
  <div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-4 pad-50-ver card" v-for="wonder in wonders_data" :key="wonder.id">
          <div
            class="card-inner"
          ...
          >
            ...
            <div class="card-bottom pad-50-hor" v-show="!hover_flag || active_id != wonder.id">
              <div class="min-width-160">
                <span class="bold">Exercise Level:</span>
                <star-rating
  ...
  data() {
    return {
      ...
      options: [
        ...
        { value: "a", text: "Exercise Level" },
        { value: "b", text: "Friends" }
      ],
